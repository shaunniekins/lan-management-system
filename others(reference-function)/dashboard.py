...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        # configure window
        self.title("LAN Connect Dashboard")
...
#         # store a reference to the login window
...
#         # create dashboard content here

#     def back_to_login_event(self):
#         # destroy the dashboard window
#         self.destroy()

#         # bring the login window back up
